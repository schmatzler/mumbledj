...
func (suite *CacheSizeCommandTestSuite) SetupSuite() {
	...
	DJ.BotConfig.Aliases.CacheSize = []string{"cachesize", "cs"}
	DJ.BotConfig.Descriptions.CacheSize = "cachesize"
	DJ.BotConfig.Permissions.CacheSize = true
}
...
func (suite *CacheSizeCommandTestSuite) TestExecuteWhenCachingIsDisabled() {
	DJ.BotConfig.Cache.Enabled = false
